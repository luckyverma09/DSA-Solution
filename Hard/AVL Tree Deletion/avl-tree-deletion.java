...
class Sol {
    ...
    public static Node leftRotate(Node root) {
        ...
        newMid.height = Math.max(height(newMid.left), height(newMid.right)) + 1;
    ...
    public static Node successorInorder(Node root) {
        Node curr = root;
    ...
    public static Node deleteNode(Node root, int data) {
        ...
        if (data < root.data)
            ...
            Node successor = successorInorder(root.right);
